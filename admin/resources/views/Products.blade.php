...
<div id="mainDivCourse" class="container-fluid d-none">
    <div class="row">
        <div class="col-md-12 p-3">
            <button id="addbtnproduct" class="btn btn-sm btn-danger my-3">Add New</button>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input id="pddes" type="text" id="" class="form-control mb-3" placeholder="Product Description">
                            <input id="pdprice" type="text" id="" class="form-control mb-3" placeholder="Product Price">
                            <input id="pdoffer" type="text" id="" class="form-control mb-3" placeholder="Offer Price">
                            <input id="pdquantity" type="text" id="" class="form-control mb-3" placeholder="Product Quantity">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="pdstatus" type="text" id="" class="form-control mb-3" placeholder="Product Status">
                            <input type="file" name="pdimage" id="pdimage" class="form-control mb-3">
                            <img id="imginputshow" style="height: 100px !important;" class="imgPreview mt-3 " src="{{ asset('images/default-image.png') }}" />
...
<!-- Modal Delete -->
<div class="modal fade" id="productModalCourse" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div id="coursesEditForm" class="container d-none ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="pdbrandupdate" style="margin-bottom: 10px;" class="browser-default custom-select">


                            </select>
                            <input id="pdstatusupdate" type="text" id="" class="form-control mb-3" placeholder="Product Status">
                            <input type="file" id="pdimageupdate" class="form-control mb-3">
                            <img id="imagepreviewproduct" style="height: 100px !important;" class="imgPreview mt-3 " src="" />
...
<script type="text/javascript">
        ...
        axios.get('/getcategory')
            .then(function(response) {
                ...
                $.each(dataJSON, function(i, item) {
                    ...
                    $('#pdcategory').append(`<option value="${dataJSON[i].id}"> ${dataJSON[i].category_name} </option>`);
        ...
        axios.get('/getbrand')
            .then(function(response) {
                ...
                $.each(dataJSON, function(i, item) {
                    ...
                    $('#pdbrand').append(`<option value="${dataJSON[i].id}"> ${dataJSON[i].brand_name} </option>`);
    ...
    $('#productAddConfirmBtn').click(function() {
        ...
        if (name.length == 0) {
            ...
            // for (const key of pdimage.files) {
            ...
            .then(function(response) {
                ...
                $.each(dataJSON, function(i, item) {
                    if (brand_id == dataJSON[i].id) {
                        $('#pdbrandupdate').append(`<option  selected value="${dataJSON[i].id}"> ${dataJSON[i].brand_name} </option>`);
                    } else {
                        $('#pdbrandupdate').append(`<option value="${dataJSON[i].id}"> ${dataJSON[i].brand_name} </option>`);
                    }
            ...
            .then(function(response) {
                ...
                $.each(dataJSON, function(i, item) {
                    if (cat_id == dataJSON[i].id) {
                        $('#pdcategoryupdate').append(`<option  selected value="${dataJSON[i].id}"> ${dataJSON[i].category_name} </option>`);
                    } else {
                        $('#pdcategoryupdate').append(`<option value="${dataJSON[i].id}"> ${dataJSON[i].category_name} </option>`);
                    }
                });
